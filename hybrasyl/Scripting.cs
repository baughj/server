...
namespace Hybrasyl
{
    ...
    public struct ScriptInvocation
    {
        ...
        {
            return Script != null ? Script.ExecuteFunction(this, parameters) : Associate.Script.ExecuteFunction(this, parameters);
        }
    }
...
";
        ...
        public Script GetScript(string scriptName)
        {
            ...
            bool exists;
            // Try to find "name.py" or "name"
            exists = Scripts.TryGetValue($"{scriptName.ToLower()}.py", out script);
            if (!exists)
            {
